...
Route::get('/export/csv/{field?}', [BookController::class, 'exportToCSV'])->name('books.export-csv');
Route::get('/export/xml/{field?}', [BookController::class, 'exportToXML'])->name('books.export-xml');
